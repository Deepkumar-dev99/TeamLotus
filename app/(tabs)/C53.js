    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.mainContent}>
          ...
          <Text style={styles.sectionTitle}>INTRODUCTIONS AND INSPIRATIONS</Text>
          ...
          <View style={styles.subcategoryList}>
            {['Characterization and Voice', 'Scenes and Senses', 'Form and Structure', 'Dialogue'].map((subcategory, index) => (
