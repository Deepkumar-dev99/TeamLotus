  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Lotus Learning</Text>
        <Image source={{ uri: 'https://i.imgur.com/1tMFzp8.png' }} style={styles.alertIcon} />
        <Image source={{ uri: 'https://i.imgur.com/1tMFzp8.png' }} style={styles.menuIcon} />
      </View>
...
<View style={styles.progressContainer}>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.lessonImageContainer}>
            <Image source={{ uri: 'https://i.imgur.com/1tMFzp8.png' }} style={styles.lessonImage} />
          ...
          <View style={styles.lessonList}>
            {[{ title: 'Lesson 2', time: '1 Hour, 10 min' }, { title: 'Lesson 3', time: '1 Hour, 10 min' }].map((lesson, index) => (
              <TouchableOpacity key={index} style={styles.lessonItem}>
                <Image source={{ uri: 'https://i.imgur.com/1tMFzp8.png' }} style={styles.lessonThumbnail} />
      ...
      <View style={styles.bottomNav}>
        <Image source={{ uri: 'https://i.imgur.com/1tMFzp8.png' }} style={styles.navIcon} />
        <Image source={{ uri: 'https://i.imgur.com/1tMFzp8.png' }} style={styles.navIcon} />
        <Image source={{ uri: 'https://i.imgur.com/1tMFzp8.png' }} style={styles.navIcon} />
        <Image source={{ uri: 'https://i.imgur.com/1tMFzp8.png' }} style={styles.navIcon} />
        <Image source={{ uri: 'https://i.imgur.com/1tMFzp8.png' }} style={styles.navIcon} />
